...
public class ViShopRequest {
    ...
    protected Request prepareGetRequest(final String url, final String apiKey) {
        return this.prepareRequest(url, apiKey).build();
    }

    protected Request preparePutRequest(final String url, final String apiKey, final RequestBody body) {
        return this.prepareRequest(url, apiKey).put(body).build();
    }

    private Request.Builder prepareRequest(final String url, final String apiKey) {
